...
define contrail_database (
    ...
    contrail_v3::contrail_common::report_status {"database_started": state => "database_started"}
    ...
    contrail_v3::contrail_common::report_status {"database_completed": state => "database_completed"}
