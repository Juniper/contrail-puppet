class openstack::resources::connectors {
  ...
  if ($internal_vip != "" and $internal_vip != undef) {
    ...
    $nova_management_address = $::contrail::params::host_non_mgmt_ip
    $heat_management_address = $::contrail::params::host_non_mgmt_ip
    $keystone_management_address = $::contrail::params::host_non_mgmt_ip
  }
