...
class contrail::haproxy (
    ...
    $contrail_exec_haproxy_gen = "python /opt/contrail/bin/generate_haproxy.py  && service haproxy restart && echo generate_ha_config >> /etc/contrail/contrail_openstack_exec.out"
