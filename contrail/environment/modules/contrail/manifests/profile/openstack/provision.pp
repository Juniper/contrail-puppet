...
class contrail::profile::openstack::provision (
  ...
  if ($contrail_internal_vip != "" and $contrail_internal_vip != undef) {
    ...
    $controller_address_management = $::contrail::params::config_ip_list[0]
    $address_api =  $::contrail::params::config_ip_list[0]
    $storage_address_management =  $::contrail::params::config_ip_list[0]
    $storage_address_api =  $::contrail::params::config_ip_list[0]
  }
