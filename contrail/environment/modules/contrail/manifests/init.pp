...
class contrail (
	...
	keystone_ip =>				hiera(openstack::keystone_ip, hiera(contrail::params::keystone_ip, $keystone_ip)),
	keystone_admin_password =>		hiera(openstack::keystone_admin_password, hiera(contrail::params::keystone_admin_password, $keystone_admin_password)),
	keystone_admin_user =>			hiera(openstack::keystone_admin_user, hiera(contrail::params::keystone_admin_user, $keystone_admin_user)),
	keystone_admin_tenant =>		hiera(openstack::keystone_admin_tenant, hiera(contrail::params::keystone_admin_tenant, $keystone_admin_tenant)),
	keystone_service_tenant =>		hiera(openstack::keystone_service_tenant, hiera(contrail::params::keystone_service_tenant, $keystone_service_tenant)),
	keystone_region_name =>			hiera(openstack::keystone_region_name, hiera(contrail::params::keystone_region_name, $keystone_region_name)),
	multi_tenancy =>			hiera(openstack::multi_tenancy, hiera(contrail::params::multi_tenancy, $multi_tenancy)),
	quantum_port =>				hiera(openstack::quantum_port, hiera(contrail::params::quantum_port, $quantum_port)),
	quantum_service_protocol =>		hiera(openstack::quantum_service_protocol, hiera(contrail::params::quantum_service_protocol, $quantum_service_protocol)),
	keystone_auth_protocol =>		hiera(openstack::keystone_auth_protocol, hiera(contrail::params::keystone_auth_protocol, $keystone_auth_protocol)),
	neutron_service_protocol =>		hiera(openstack::neutron_service_protocol, hiera(contrail::params::neutron_service_protocol, $neutron_service_protocol)),
	keystone_auth_port =>			hiera(openstack::keystone_auth_port, hiera(contrail::params::keystone_auth_port, $keystone_auth_port)),
	keystone_insecure_flag =>		hiera(openstack::keystone_insecure_flag, hiera(contrail::params::keystone_insecure_flag, $keystone_insecure_flag)),
	amqp_server_ip =>			hiera(openstack::amqp_server_ip, hiera(contrail::params::amqp_server_ip, $amqp_server_ip)),
	...
	storage_num_hosts =>			hiera(contrail::storage::storage_num_hosts, hiera(contrail::params::storage_num_hosts, $storage_num_hosts)),
        storage_monitor_secret =>               hiera(contrail::storage::storage_mon_secret, hiera(contrail::params::storage_monitor_secret, $storage_monitor_secret)),
	osd_bootstrap_key =>			hiera(contrail::storage::osd_bootstrap_key, hiera(contrail::params::osd_bootstrap_key, $osd_bootstrap_key)),
	storage_admin_key =>			hiera(contrail::storage::admin_key, hiera(contrail::params::storage_admin_key, $storage_admin_key)),
