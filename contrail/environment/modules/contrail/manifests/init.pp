...
class contrail (
    ...
    $tor_ha_config = "",
    $nova_override_config     = {},
    $glance_override_config   = {},
    $cinder_override_config   = {},
    $keystone_override_config = {},
    $neutron_override_config  = {},
    $ceilometer_override_config = {},
    $ceph_override_config = {},
    $heat_override_config     = {},
    $contrail_version = '',
