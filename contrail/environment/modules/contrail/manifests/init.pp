...
class contrail (
    ...
    $default_xenial_kernel = '4.4.0-38',
    $redis_password = '',
    $storage_num_osd = '',
    $storage_fsid = '',
    $storage_num_hosts = '',
	...
	default_trusty_kernel =>                hiera(contrail::default_trusty_kernel, $default_trusty_kernel),
	default_xenial_kernel =>                hiera(contrail::default_xenial_kernel, $default_xenial_kernel),
	...
	storage_enabled =>			hiera(contrail::storage::enabled, hiera(contrail::params::storage_enabled, $storage_enabled)),
