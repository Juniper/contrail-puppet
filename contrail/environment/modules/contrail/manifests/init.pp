...
class contrail (
	...
	config_ip_list =>			hiera(contrail::config_ip_list, hiera(contrail::params::config_ip_list, $config_ip_list)),
	control_ip_list =>			hiera(contrail::control_ip_list, hiera(contrail::params::control_ip_list, $control_ip_list)),
	database_ip_list =>			hiera(contrail::database_ip_list, hiera(contrail::params::database_ip_list, $database_ip_list)),
	collector_ip_list =>			hiera(contrail::collector_ip_list, hiera(contrail::params::collector_ip_list, $collector_ip_list)),
	webui_ip_list =>			hiera(contrail::webui_ip_list, hiera(contrail::params::webui_ip_list, $webui_ip_list)),
	openstack_ip_list =>			hiera(contrail::openstack_ip_list, hiera(contrail::params::openstack_ip_list, $openstack_ip_list)),
	compute_ip_list =>			hiera(contrail::compute_ip_list, hiera(contrail::params::compute_ip_list, $compute_ip_list)),
	tsn_ip_list =>				hiera(contrail::tsn_ip_list, hiera(contrail::params::tsn_ip_list, $tsn_ip_list)),
	config_name_list =>			hiera(contrail::config_name_list, hiera(contrail::params::config_name_list, $config_name_list)),
	compute_name_list =>			hiera(contrail::compute_name_list, hiera(contrail::params::compute_name_list, $compute_name_list)),
	control_name_list =>			hiera(contrail::control_name_list, hiera(contrail::params::control_name_list, $control_name_list)),
	database_name_list =>			hiera(contrail::database_name_list, hiera(contrail::params::database_name_list, $database_name_list)),
	collector_name_list =>			hiera(contrail::collector_name_list, hiera(contrail::params::collector_name_list, $collector_name_list)),
	openstack_name_list =>			hiera(contrail::openstack_name_list, hiera(contrail::params::openstack_name_list, $openstack_name_list)),
	openstack_mgmt_ip_list =>		hiera(contrail::openstack_mgmt_ip_list, hiera(contrail::params::openstack_mgmt_ip_list, $openstack_mgmt_ip_list)),
	tsn_name_list =>			hiera(contrail::tsn_name_list, hiera(contrail::params::tsn_name_list, $tsn_name_list)),
	...
	openstack_passwd_list =>		hiera(contrail::openstack_passwd_list, hiera(contrail::params::openstack_passwd_list, $openstack_passwd_list)),
	openstack_user_list =>			hiera(contrail::openstack_user_list, hiera(contrail::params::openstack_user_list, $openstack_user_list)),
	compute_passwd_list =>			hiera(contrail::compute_passwd_list, hiera(contrail::params::compute_passwd_list, $compute_passwd_list)),
	...
	external_vip =>				hiera(contrail::ha::external_vip, hiera(contrail::params::external_vip, $external_vip)),
	...
	internal_virtual_router_id =>		hiera(contrail::ha::internal_virtual_router_id, hiera(contrail::params::internal_virtual_router_id, $internal_virtual_router_id)),
	external_virtual_router_id =>		hiera(contrail::ha::external_virtual_router_id, hiera(contrail::params::external_virtual_router_id, $external_virtual_router_id)),
	...
	nfs_server =>				hiera(contrail::ha::nfs_server, hiera(contrail::params::nfs_server, $nfs_server)),
	nfs_glance_path =>			hiera(contrail::ha::nfs_glance_path, hiera(contrail::params::nfs_glance_path, $nfs_glance_path)),
	tor_ha_config =>			hiera(contrail::ha::tor_ha_config, hiera(contrail::params::tor_ha_config, $tor_ha_config)),
        # database Parameters
	database_ip_port =>			hiera(contrail::database::database_ip_port, hiera(contrail::params::database_ip_port, $database_ip_port)),
	database_initial_token =>		hiera(contrail::database::database_initial_token, hiera(contrail::params::database_initial_token, $database_initial_token)),
	database_dir =>				hiera(contrail::database::database_dir, hiera(contrail::params::database_dir, $database_dir)),
	database_minimum_diskGB =>		hiera(contrail::database::database_minimum_diskGB, hiera(contrail::params::database_minimum_diskGB, $database_minimum_diskGB)),
        # Analytics Parameters
	analytics_data_ttl =>			hiera(contrail::analytics::analytics_data_ttl, hiera(contrail::params::analytics_data_ttl, $analytics_data_ttl)),
	analytics_config_audit_ttl =>		hiera(contrail::analytics::analytics_config_audit_ttl, hiera(contrail::params::analytics_config_audit_ttl, $analytics_config_audit_ttl)),
	analytics_statistics_ttl =>		hiera(contrail::analytics::analytics_statistics_ttl, hiera(contrail::params::analytics_statistics_ttl, $analytics_statistics_ttl)),
	analytics_flow_ttl =>			hiera(contrail::analytics::analytics_flow_ttl, hiera(contrail::params::analytics_flow_ttl, $analytics_flow_ttl)),
	...
	encap_priority =>			hiera(contrail::control::encap_priority, hiera(contrail::params::encap_priority, $encap_priority)),
	...
	keystone_ip =>				hiera(contrail::openstack::keystone_ip, hiera(contrail::params::keystone_ip, $keystone_ip)),
	keystone_admin_password =>		hiera(contrail::openstack::keystone_admin_password, hiera(contrail::params::keystone_admin_password, $keystone_admin_password)),
	keystone_admin_user =>			hiera(contrail::openstack::keystone_admin_user, hiera(contrail::params::keystone_admin_user, $keystone_admin_user)),
	keystone_admin_tenant =>		hiera(contrail::openstack::keystone_admin_tenant, hiera(contrail::params::keystone_admin_tenant, $keystone_admin_tenant)),
	keystone_service_tenant =>		hiera(contrail::openstack::keystone_service_tenant, hiera(contrail::params::keystone_service_tenant, $keystone_service_tenant)),
	keystone_region_name =>			hiera(contrail::openstack::keystone_region_name, hiera(contrail::params::keystone_region_name, $keystone_region_name)),
	multi_tenancy =>			hiera(contrail::openstack::multi_tenancy, hiera(contrail::params::multi_tenancy, $multi_tenancy)),
	zookeeper_ip_list =>			hiera(contrail::openstack::zookeeper_ip_list, hiera(contrail::params::zookeeper_ip_list, $zookeeper_ip_list)),
	quantum_port =>				hiera(contrail::openstack::quantum_port, hiera(contrail::params::quantum_port, $quantum_port)),
	quantum_service_protocol =>		hiera(contrail::openstack::quantum_service_protocol, hiera(contrail::params::quantum_service_protocol, $quantum_service_protocol)),
	keystone_auth_protocol =>		hiera(contrail::openstack::keystone_auth_protocol, hiera(contrail::params::keystone_auth_protocol, $keystone_auth_protocol)),
	neutron_service_protocol =>		hiera(contrail::openstack::neutron_service_protocol, hiera(contrail::params::neutron_service_protocol, $neutron_service_protocol)),
	keystone_auth_port =>			hiera(contrail::openstack::keystone_auth_port, hiera(contrail::params::keystone_auth_port, $keystone_auth_port)),
	keystone_insecure_flag =>		hiera(contrail::openstack::keystone_insecure_flag, hiera(contrail::params::keystone_insecure_flag, $keystone_insecure_flag)),
	amqp_server_ip =>			hiera(contrail::openstack::amqp_server_ip, hiera(contrail::params::amqp_server_ip, $amqp_server_ip)),
	openstack_manage_amqp =>		hiera(contrail::openstack::openstack_manage_amqp, hiera(contrail::params::openstack_manage_amqp, $openstack_manage_amqp)),
	mysql_root_password =>			hiera(contrail::openstack::mysql_root_password, hiera(contrail::params::mysql_root_password, $mysql_root_password)),
	metadata_secret =>			hiera(contrail::openstack::metadata_secret, hiera(contrail::params::metadata_secret, $metadata_secret)),
	enable_ceilometer =>			hiera(contrail::openstack::enable_ceilometer, hiera(contrail::params::enable_ceilometer, $enable_ceilometer)),
        # Config Parameters
	...
	sync_db =>				hiera(contrail::config::sync_db, hiera(contrail::params::sync_db, $sync_db)),
	...
	vmware_password =>			hiera(contrail::vmware::vmware_password, hiera(contrail::params::vmware_password, $vmware_password)),
	vmware_vswitch =>			hiera(contrail::vmware::vmware_vswitch, hiera(contrail::params::vmware_vswitch, $vmware_vswitch)),
        # Virtual Gateway Parameters
	vgw_public_subnet =>			hiera(contrail::vgw::vgw_public_subnet, hiera(contrail::params::vgw_public_subnet, $vgw_public_subnet)),
	vgw_public_vn_name =>			hiera(contrail::vgw::vgw_public_vn_name, hiera(contrail::params::vgw_public_vn_name, $vgw_public_vn_name)),
	vgw_interface =>			hiera(contrail::vgw::vgw_interface, hiera(contrail::params::vgw_interface, $vgw_interface)),
	vgw_gateway_routes =>			hiera(contrail::vgw::vgw_gateway_routes, hiera(contrail::params::vgw_gateway_routes, $vgw_gateway_routes)),
        # Storage Parameters
