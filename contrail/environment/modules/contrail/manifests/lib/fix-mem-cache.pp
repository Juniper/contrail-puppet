## TODO: 1. fix-memcache-conf should be changed to match filename or filename
## TODO:    should be changed to match function name
## TODO: 2. fix-memcache-conf() should not have '-' hyphen
