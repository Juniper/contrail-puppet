class contrail::compute::config(
  ...
  $control_ip_port_list   = $::contrail::params::control_ip_port_list,
  $dns_ip_port_list       = $::contrail::params::dns_ip_port_list,
  ...
  contrail_vrouter_agent_config {
    ...
    'CONTROL-NODE/servers'         : value => "$control_ip_port_list";
    'DNS/servers'                  : value => "$dns_ip_port_list";
