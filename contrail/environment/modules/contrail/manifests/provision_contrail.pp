...
class contrail::provision_contrail (
    ...
    class {'::contrail::exec_provision_control':
         contrail_exec_provision_control => $contrail_exec_provision_control
    }
    ->
    ...
    class {'::contrail::provision_metadata_services':
         ...
         openstack_ip_to_use => $openstack_ip_to_use
    }
    ->
    ...
    class {'::contrail::provision_role_config':
        config_ip_list_for_shell => $config_ip_list_for_shell,
        config_name_list_for_shell => $config_name_list_for_shell,
        config_ip => $config_ip,
        keystone_admin_user => $keystone_admin_user,
        keystone_admin_password => $keystone_admin_password,
    ...
    class {'::contrail::provision_role_database':
        database_ip_list_for_shell => $database_ip_list_for_shell,
        database_name_list_for_shell => $database_name_list_for_shell,
        config_ip => $config_ip,
        keystone_admin_user => $keystone_admin_user,
        keystone_admin_password => $keystone_admin_password,
        keystone_admin_tenant => $keystone_admin_tenant
    ...
    class {'::contrail::provision_role_collector':
        collector_ip_list_for_shell => $collector_ip_list_for_shell,
        collector_name_list_for_shell => $collector_name_list_for_shell,
        config_ip => $config_ip,
        keystone_admin_user => $keystone_admin_user,
        keystone_admin_password => $keystone_admin_password,
        keystone_admin_tenant => $keystone_admin_tenant
